package com.vcentry.lab.screenshotgenetor;
...
public class ScreenshotGenerator extends Initializer{
	public static void generateScreenshot(ITestResult r) throws IOException{
		...
		public static String takeScreenshot(String name) throws IOException{
			File src=((TakesScreenshot)wd).getScreenshotAs(org.openqa.selenium.OutputType.FILE);
			File dst=new File("C:/Users/siree/workspace/H2_DDDTest/screenshot/"+name+".png");
